...
print("Total:", total)
print("Sem duplicatas:", unicos)
print("Há duplicatas?" , "Sim" if total > unicos else "Não")
...
print(valores_missing_selecionado)df_apgar = df_selecionado.dropna(subset=['APGAR5'])
